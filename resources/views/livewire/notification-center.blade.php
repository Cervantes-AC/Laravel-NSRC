<div class="relative" x-data="{ open: false }" aria-label="{{ __('Notifications') }}">
    ...
    <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-80 sm:w-96 bg-white border border-gray-200 rounded-lg shadow-lg z-50" role="dialog" aria-label="{{ __('Notification list') }}">
