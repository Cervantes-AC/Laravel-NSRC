            ...
            <div x-data="analyticsApp" class="space-y-6" aria-label="{{ __('Analytics') }}">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-1.5">{{ __('From') }}</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-1.5">{{ __('To') }}</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-1.5">{{ __('Sector') }}</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all">
                        <div class="flex items-center justify-between mb-3">
                            <p class="text-xs font-bold text-gray-500 uppercase tracking-widest">{{ __('Total Sessions') }}</p>
                        ...
                        <p class="text-3xl font-bold text-gray-900 leading-none" x-text="totalSessions"></p>
                        <p class="text-xs text-gray-500 mt-1 font-medium">{{ __('All time') }}</p>
                    </div>
                    <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all">
                        <div class="flex items-center justify-between mb-3">
                            <p class="text-xs font-bold text-gray-500 uppercase tracking-widest">{{ __('Total Hours') }}</p>
                        ...
                        <p class="text-3xl font-bold text-indigo-600 leading-none" x-text="(totalHours / 60).toFixed(1)"></p>
                        <p class="text-xs text-gray-500 mt-1 font-medium">{{ __('Volunteer hours logged') }}</p>
                    </div>
                    <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all">
                        <div class="flex items-center justify-between mb-3">
                            <p class="text-xs font-bold text-gray-500 uppercase tracking-widest">{{ __('Active Volunteers') }}</p>
                        ...
                        <p class="text-3xl font-bold text-green-600 leading-none" x-text="activeVolunteers"></p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="lg:col-span-2 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                        <h3 class="text-base font-bold text-gray-900 mb-4">{{ __('Session Trends') }}</h3>
                    ...
                    <div class="space-y-4">
                        <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                            <h3 class="text-base font-bold text-gray-900 mb-4">{{ __('Quick Insights') }}</h3>
                            <div class="space-y-4">
                                <div class="flex items-center gap-3 p-3 bg-amber-50 border border-amber-200 rounded-xl">
                                    ...
                                    <div>
                                        <p class="text-xs font-bold text-gray-500 uppercase tracking-widest">{{ __('Peak Day') }}</p>
                                        <p class="text-sm font-bold text-gray-900"><span x-text="insights.peak_day || 'N/A'"></span> <span class="font-normal text-gray-500" x-text="'(' + (insights.peak_day_count || 0) + ' sessions)'"></span></p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 p-3 bg-blue-50 border border-blue-200 rounded-xl">
                                    ...
                                    <div>
                                        <p class="text-xs font-bold text-gray-500 uppercase tracking-widest">{{ __('Avg / Volunteer') }}</p>
                                        <p class="text-sm font-bold text-gray-900"><span x-text="insights.avg_hours_per_volunteer || 0"></span> <span class="font-normal text-gray-500">hours</span></p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 p-3 bg-green-50 border border-green-200 rounded-xl">
                                    ...
                                    <div>
                                        <p class="text-xs font-bold text-gray-500 uppercase tracking-widest">{{ __('Total Hours') }}</p>
                                        <p class="text-sm font-bold text-gray-900"><span x-text="insights.total_hours_rounded || 0"></span> <span class="font-normal text-gray-500">hours logged</span></p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3 p-3 bg-emerald-50 border border-emerald-200 rounded-xl">
                                    ...
                                    <div>
                                        <p class="text-xs font-bold text-gray-500 uppercase tracking-widest">{{ __('Efficiency') }}</p>
                                        <p class="text-sm font-bold text-gray-900"><span x-text="insights.efficiency || 0"></span>% <span class="font-normal text-gray-500">completion rate</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                            <h3 class="text-base font-bold text-gray-900 mb-4">{{ __('Status Breakdown') }}</h3>
