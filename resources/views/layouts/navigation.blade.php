    ...
    if (Auth::user()->role === 'member') {
        ...
        $navSections['resources'] = [
            ...
            'items' => [
                ...
                ['label' => __('Announcements'), 'route' => 'notifications.index', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592L6.5 17H5a2 2 0 01-2-2v-4a2 2 0 012-2h1.5l8.447-3.224A1 1 0 0116.3 6.71v10.58a1 1 0 01-1.353.936L11 16.718M18 10.5a3.5 3.5 0 010 5" />', 'active' => request()->routeIs('notifications.index')],
            ]
        ];
    }
