<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-slate-800 leading-tight">{{ __('Admin Dashboard') }}</h2>
    </x-slot>
    <div class="py-8">
                            ...
                            <div class="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <select x-model="statusFilter" @change="loadData()" class="bg-white/15 backdrop-blur border-0 text-white text-sm rounded-xl px-3 py-1.5 font-medium">
                                        ...
                                        <option value="COMPLETE" class="text-slate-900">Complete</option>
                                        <option value="ONGOING" class="text-slate-900">Ongoing</option>
                                        <option value="MISSING_TIMEOUT" class="text-slate-900">Missing</option>
                                        <option value="INVALID_LOG" class="text-slate-900">Invalid</option>
                                    </select>
                                    <select x-model="sectorFilter" @change="loadData()" class="bg-white/15 backdrop-blur border-0 text-white text-sm rounded-xl px-3 py-1.5 font-medium">
                                        <option value="" class="text-slate-900">All Sectors</option>
                                        <template x-for="s in sectors" :key="s">
                                            <option :value="s" class="text-slate-900" x-text="s"></option>
                                        </template>
                                    </select>
                        ...
                        <template x-if="data.weeklyMetrics && data.weeklyMetrics.session_count > 0">
                            <div class="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
                                <div class="flex items-center justify-between mb-3">
                                    <div>
                                        <h3 class="text-sm font-semibold text-slate-900">Weekly Compliance</h3>
